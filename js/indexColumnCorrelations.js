let requestUrl = "http://167.99.13.127:8001/column-correlation";
        ...
        let options = {
            ...
            success: (result) => {
                ...
                g.setOption({
                    ...
                    xAxis: [{type: "value", scale: !0, axisLabel: {formatter: "{value}"}}],
                    yAxis: [{type: "value", scale: !0, axisLabel: {formatter: "{value}"}}],
                    series: [{
                        name: "Data1",
                        type: "scatter",
                        // tooltip: {
